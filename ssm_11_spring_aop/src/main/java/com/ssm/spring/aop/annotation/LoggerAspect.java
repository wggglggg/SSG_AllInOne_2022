...
public class LoggerAspect {
    ...
    @Pointcut("execution(* com.ssm.spring.aop.annotation.CalculatorImpl.*(..))")
    public void pointCut(){
    ...
    @After("execution(* com.ssm.spring.aop.annotation.CalculatorImpl.*(..))")
     ...
     */
    @AfterReturning(value = "execution(* com.ssm.spring.aop.annotation.CalculatorImpl.*(..))", returning = "result")
     ...
     */
    @AfterThrowing(value = "execution(* com.ssm.spring.aop.annotation.CalculatorImpl.*(..))", throwing = "ex")
    ...
    @Around("execution(* com.ssm.spring.aop.annotation.CalculatorImpl.*(..))")
